...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    askonce: "Ask once, get answers from all AI models.",
  ...
  overview: {
    service: {
      ...
      subtitle: "Control the gateway service.",
      statusRunning: "Running",
      statusStopped: "Not Started",
      restart: "Restart",
      stop: "Stop",
      restarting: "Restarting...",
      stopping: "Stopping...",
      restartConfirm: "Are you sure you want to restart the gateway? This will disconnect all clients temporarily.",
      stopConfirm: "Are you sure you want to stop the gateway? This will disconnect all clients and the UI will become unavailable.",
      restartSuccess: "Gateway restarted and reconnected.",
      restartWaiting: "Gateway restarting, waiting for reconnection...",
      restartTimeout: "Restart timed out, please refresh the page manually.",
      stopSuccess: "Gateway stopping...",
      securityNote: "Security: Service control is only allowed from localhost.",
    },
    access: {
