...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    service: {
      ...
      restarting: "正在重启...",
      stopping: "正在停止...",
      restartConfirm: "确定要重启网关吗？这将暂时断开所有客户端连接。",
      stopConfirm: "确定要停止网关吗？这将断开所有客户端连接，且 UI 页面将不可用。",
      restartSuccess: "网关重启成功，已重新连接。",
      restartWaiting: "网关正在重启，等待重连...",
      restartTimeout: "重启超时，请手动刷新页面。",
      stopSuccess: "网关正在停止...",
      securityNote: "安全提示：服务控制仅允许本机访问。",
    },
    access: {
      title: "网关访问",
